...
#define kNumAugmentationTextures 90
...
@private
    ...
    Texture* augmentationTexture[181];
//    Texture* augmentationTexturePeople[kNumAugmentationTextures];
//    Texture* augmentationTextureFountain[90];
